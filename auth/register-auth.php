                                ...
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 mb-20">
                                            ...
                                            <input class="mb-0" name="first-name" type="text" name="first-name" placeholder="First Name">
                                        </div>
                                        <div class="col-md-6 col-12 mb-20">
                                            <label>Last Name</label>
                                            <input class="mb-0" type="text" name="last-name" placeholder="Last Name">
                                        </div>
                                        ...
                                        <aside class="col-md-12 alert w-100 alert-danger">
                                            <?php echo $errors[0]; ?>
                                        </aside>
                                        <div class="col-12">
